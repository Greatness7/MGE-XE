...
public:
    static IDirect3DSurface9* dsvSubstituteFrom;
    static IDirect3DSurface9* dsvSubstituteTo;
    ...
    static void setDepthStencilSubstitute(IDirect3DSurface9* from, IDirect3DSurface9* to);
